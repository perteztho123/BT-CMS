        ...
        <div className="relative bg-white rounded-2xl shadow-2xl p-6 sm:p-8 max-w-lg w-full animate-fadeIn">
          ...
          <div className="space-y-4 text-gray-800 text-sm">
            <div className="flex items-start gap-3 bg-blue-50 rounded-lg p-3 hover:shadow-md transition duration-300">
              <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/administrator-male%281%29-wAbTDqV3nvx2HRMd9tPEO9CS96kmuQ.png" alt="dail..." className="w-6 h-6 mt-1" />
            ...
            <div className="flex items-start gap-3 bg-purple-50 rounded-lg p-3 hover:shadow-md transition duration-300">
              <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/family%281%29-DsSm8Zbzp3M1PwO56SUpZygAgWaUVI.png" alt="dail..." className="w-6 h-6 mt-1" />
              <p><strong>MSWD:</strong> <a href="tel:1343" className="text-yellow-500 hover:underline">1343</a></p>
            </div>
            <div className="flex items-start gap-3 bg-blue-50 rounded-lg p-3 hover:shadow-md transition duration-300">
              <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/medical-doctor%281%29-7HBNKZ63t8o5gDY0BI3BhCWHJQY8hm.png" alt="dail..." className="w-6 h-6 mt-1" />
              <p><strong>Medical/MHO:</strong> <a href="tel:0523456789" className="text-yellow-500 hover:underline">(052) 345-6789</a></p>
            </div>
            <div className="flex items-start gap-3 bg-blue-50 rounded-lg p-3 hover:shadow-md transition duration-300">
              <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/policeman-male%281%29-IRf4TeaWK1OBgDcnd6agkHT6TeFwET.png" alt="dail..." className="w-6 h-6 mt-1" />
            ...
            <div className="flex items-start gap-3 bg-orange-50 rounded-lg p-3 hover:shadow-md transition duration-300">
              <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/fire-element%281%29-qfRhimXY1uumuEPsOYpzRvAWz2PlgJ.png" alt="dail..." className="w-6 h-6 mt-1" />
